...
class Filehandler{
    ...
    protected 	$allowed_extensions = array("gif", "jpeg", "jpg", "png");
    ...
    public static function preProcessFile(Filesobject $file) {
    ...
    public static function saveFileToDB(Filesobject $file, $table){
    	$created_by = '';
...
//        }
    ...
    public static function handleFile1(Filesobject $file) {
    ...
    public static function handleFile(Filesobject $file) {
    	$this->handleFileTypes($file);
    	$this->preProcessFile($file);
    	$this->processFile($file);
    	try {
